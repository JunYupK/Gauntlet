...
public final class Match {
    ...
    /**
     * 경기 시작 시점의 격자. 시작 칸 2개(양쪽 봇)와 그 바로 뒤 칸 2개까지
     * 최대 4칸이 벽으로 확정된 상태로 돌아온다. {@link StartPositions#of}로
     * 뽑은 배치라면 MARGIN(≥3칸) 덕분에 뒤 칸이 항상 격자 안이라 정확히
     * 4칸이다 — 다만 이 메서드는 {@code StartPositions}의 공개 정준 생성자로
     * 만든 임의의 배치도 받으므로, 봇을 가장자리에 둔 배치라면
     * {@link #claimBehind}가 격자 밖 뒤 칸을 조용히 건너뛰어 4칸보다
     * 적을 수 있다.
     *
